...
@ComponentScan({ "com.customshop.back" })
@EnableJpaRepositories(basePackages = "com.customshop.back.model.repo")
public class PersistenceJPAConfig {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.customshop.back.model.entity");
